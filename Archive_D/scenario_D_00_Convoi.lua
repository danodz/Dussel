...
-- Part 1
    alert = {
        init = function() 
            sendCommToAll(ResistanceStation, "Appel à l'aide ! Nous avons reconquis une base au Duc au secteur E2, mais les loyalistes sont revenus en force. Nous avons besoin d'aide !");
...
function init()
    ...
    vasserand = PlayerSpaceship():setFaction("Vindh"):setTemplate("VCorvette"):setCallSign("VSR"):setPosition(-95000, 32500);
-- Batterie d'appoint
...
vasserand:setWeaponStorage("Nuke", 1);
    ...
    players = { PlayerSpaceship():setFaction("Arianne"):setTemplate("ACorvette"):setCallSign("SCHER"):setPosition(-95000, 32500)
              , vasserand
              };
