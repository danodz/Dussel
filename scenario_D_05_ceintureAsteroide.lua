...
function init()
    ...
    players = { --PlayerSpaceship():setFaction("Arianne"):setTemplate("ACorvette"):setCallSign("ARI"):setPosition(-7640, 39663)
              PlayerSpaceship():setFaction("Vindh"):setTemplate("VCorvette"):setCallSign("Larth1"):setPosition(21000, 85400):setWeaponStorage("Nuke", 0)
              , PlayerSpaceship():setFaction("Vindh"):setTemplate("VCorvette"):setCallSign("Vasserand"):setPosition(21000, 85400):setWeaponStorage("Nuke", 0)
              , PlayerSpaceship():setFaction("Loyalistes"):setTemplate("MCorvette"):setCallSign("Ducal-2"):setPosition(45500, -25000):setWeaponStorage("Nuke", 0):setReputationPoints(150):setShieldsMax(160, 160)
