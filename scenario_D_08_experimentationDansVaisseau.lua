...
scenarioParts = {
    ...
    explore = {
        init = function()
            sendCommToAll(station, "Le systeme de defence est trop puissant, hackez le avant de le detruire. L'int√rieur du vaisseau surchauffe, d√truisez le r√acteur avant d'aborder.");
        end,
        update = function()
